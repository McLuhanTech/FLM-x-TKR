...
CREATE TABLE `cinema_info` (
  ...
  `cinema_code` varchar(16) NOT NULL COMMENT '专资编码',
  `cinema_name` varchar(64) NOT NULL COMMENT '影院名称',
  `cinema_address` varchar(256) NOT NULL COMMENT '影院地址',
  `conact_name` varchar(16) NOT NULL COMMENT '联系人',
  `conact_phone` varchar(64) NOT NULL COMMENT '联系电话',
  `token` varchar(256) NOT NULL COMMENT '唯一标示，定时刷新',
  `status` int(11) NOT NULL COMMENT '状态1-允许下载kdm 2-禁止下载',
  `create_by` varchar(16) DEFAULT NULL COMMENT '创建人',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_by` varchar(16) DEFAULT NULL COMMENT '修改人',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `flm_info`;
CREATE TABLE `flm_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cinema_info_id` int(11) NOT NULL,
  `flm_data_id` int(11) NOT NULL,
  `type` varchar(8) DEFAULT NULL COMMENT '类型add/update',
  `flm_md5` varchar(256) DEFAULT NULL COMMENT 'flm消息md5',
  `message_id` varchar(256) NOT NULL COMMENT '消息id',
  `is_report` int(11) NOT NULL default 1 COMMENT '是否上报',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

DROP TABLE IF EXISTS `flm_data`;
CREATE TABLE `flm_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cinema_info_id` int(11) NOT NULL,
  `flm` mediumtext NOT NULL COMMENT 'flm消息',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT = 'FLM数据表';

DROP TABLE IF EXISTS `flm_parsing_auditorium`;
CREATE TABLE `flm_parsing_auditorium` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cinema_info_id` int(11) NOT NULL COMMENT '影院ID',
  `cinema_name` varchar(64) NOT NULL COMMENT '影院名称',
  `flm_info_id` int(11) NOT NULL,
  `message_id` varchar(256) NOT NULL COMMENT '消息id',
  `auditorium_number` varchar(8) NOT NULL COMMENT '影厅编号',
  `auditorium_name` varchar(32) NOT NULL COMMENT '影厅名称',
  `device_identifier` varchar(256) NOT NULL COMMENT '设备识别',
  `manufacturer_name` varchar(64) NOT NULL COMMENT '制造商名称',
  `model_number` varchar(64) NOT NULL COMMENT '设备型号',
  `is_active` varchar(8) NOT NULL COMMENT '设备状态',
  `post_type` varchar(8) NOT NULL COMMENT '数据状态',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT = '设备列表表';


DROP TABLE IF EXISTS `kdm_fail_info`;
CREATE TABLE `kdm_fail_info` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `source` varchar(64) NOT NULL COMMENT '秘钥分发机构',
  `host` varchar(64) DEFAULT NULL COMMENT '下载主机',
...
DROP TABLE IF EXISTS `kdm_info`;
CREATE TABLE `kdm_info` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `uuid` varchar(64) NOT NULL COMMENT '影片uuid',
  `certificate` varchar(64) NOT NULL COMMENT '服务器公钥',
  `source` varchar(64) NOT NULL COMMENT '来源',
  `host` varchar(64) DEFAULT NULL COMMENT '主机',
  `path` varchar(256) NOT NULL COMMENT '文件目录',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- ----------------------------
INSERT INTO `sys_config` VALUES (1, '主框架页-默认皮肤样式名称', 'sys.index.skinName', 'skin-blue', 'Y', 'admin', '2018-03-16 11:33:00', 'admin', '2019-12-17 14:10:12', '蓝色 skin-blue、绿色 skin-green、紫色 skin-purple、红色 skin-red、黄色 skin-yellow');
INSERT INTO `sys_config` VALUES (2, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00', '初始化密码 123456');
INSERT INTO `sys_config` VALUES (3, '推送FLM数据URL', 'sys.report.flm.url', '', 'Y', 'admin', '2020-11-16 11:33:00', 'ry', '2020-11-16 11:33:00', '推送FLM数据URL');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES (100, 0, '0', 'xx集团', 0, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
...
INSERT INTO `sys_dept` VALUES (102, 100, '0,100', '上海分公司', 2, '若依', '15888888888', 'ry@qq.com', '0', '0', 'admin', '2018-03-16 11:33:00', 'ry', '2018-03-16 11:33:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 27 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '字典数据表' ROW_FORMAT = Dynamic;
...
-- Records of sys_job
-- ----------------------------
INSERT INTO `sys_job` VALUES (1, 'ryTask', '系统默认（无参）', 'pushFlmJob', '', '0/30 * * * * ?', '3', '1', '0', 'admin', '2020-11-16 11:33:00', 'ry', '2020-11-16 11:33:00', '');
...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 3, '#', 'menuItem', 'M', '0', '', 'fa fa-gear', 'admin', '2018-03-16 11:33:00', 'admin', '2019-12-25 14:50:44', '系统管理目录');
INSERT INTO `sys_menu` VALUES (2, '系统监控', 0, 4, '#', 'menuItem', 'M', '0', '', 'fa fa-video-camera', 'admin', '2018-03-16 11:33:00', 'admin', '2019-12-25 14:50:53', '系统监控目录');
INSERT INTO `sys_menu` VALUES (3, '系统工具', 0, 5, '#', 'menuItem', 'M', '1', '', 'fa fa-bars', 'admin', '2018-03-16 11:33:00', 'admin', '2020-08-16 19:00:17', '系统工具目录');
...
INSERT INTO `sys_menu` VALUES (107, '通知公告', 1, 8, '/system/notice', 'menuItem', 'C', '1', 'system:notice:view', '#', 'admin', '2018-03-16 11:33:00', 'admin', '2019-12-25 16:44:08', '通知公告菜单');
...
INSERT INTO `sys_menu` VALUES (2000, '影院管理', 2010, 1, '/system/cinemaInfo', 'menuItem', 'C', '0', 'system:cinemaInfo:view', '#', 'admin', '2018-03-01 00:00:00', 'admin', '2019-12-17 14:22:30', '影院菜单');
INSERT INTO `sys_menu` VALUES (2001, '影院查询', 2000, 1, '#', '', 'F', '0', 'system:cinemaInfo:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2002, '影院新增', 2000, 2, '#', '', 'F', '0', 'system:cinemaInfo:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2003, '影院修改', 2000, 3, '#', '', 'F', '0', 'system:cinemaInfo:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2004, '影院删除', 2000, 4, '#', '', 'F', '0', 'system:cinemaInfo:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2005, '秘钥监控', 2011, 1, '/system/kdmFailInfo', '', 'C', '0', 'system:kdmFailInfo:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '秘钥失败详情菜单');
INSERT INTO `sys_menu` VALUES (2006, '秘钥监控查询', 2005, 1, '#', '', 'F', '0', 'system:kdmFailInfo:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2007, '秘钥监控新增', 2005, 2, '#', '', 'F', '0', 'system:kdmFailInfo:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2008, '秘钥监控修改', 2005, 3, '#', '', 'F', '0', 'system:kdmFailInfo:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2009, '秘钥监控删除', 2005, 4, '#', '', 'F', '0', 'system:kdmFailInfo:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2010, '影院管理', 0, 1, '#', 'menuItem', 'M', '0', '', 'fa fa-film', 'admin', '2019-12-25 14:32:35', 'admin', '2019-12-25 14:33:00', '');
INSERT INTO `sys_menu` VALUES (2011, '秘钥管理', 0, 2, '#', 'menuItem', 'M', '0', NULL, 'fa fa-key', 'admin', '2019-12-25 14:50:23', '', NULL, '');
INSERT INTO `sys_menu` VALUES (2012, 'FLM消息', 2010, 2, '/system/flmInfo', '', 'C', '0', 'system:flmInfo:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', 'flm菜单');
INSERT INTO `sys_menu` VALUES (2013, 'flm查询', 2012, 1, '#', '', 'F', '0', 'system:flmInfo:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2014, 'flm新增', 2012, 2, '#', '', 'F', '0', 'system:flmInfo:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2015, 'flm修改', 2012, 3, '#', '', 'F', '0', 'system:flmInfo:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2016, 'flm删除', 2012, 4, '#', '', 'F', '0', 'system:flmInfo:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2017, '秘钥记录', 2011, 2, '/system/kdmInfo', '', 'C', '0', 'system:kdmInfo:view', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '秘钥记录菜单');
INSERT INTO `sys_menu` VALUES (2018, '秘钥记录查询', 2017, 1, '#', '', 'F', '0', 'system:kdmInfo:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2019, '秘钥记录新增', 2017, 2, '#', '', 'F', '0', 'system:kdmInfo:add', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2020, '秘钥记录修改', 2017, 3, '#', '', 'F', '0', 'system:kdmInfo:edit', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2021, '秘钥记录删除', 2017, 4, '#', '', 'F', '0', 'system:kdmInfo:remove', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
INSERT INTO `sys_menu` VALUES (2022, '设备列表', 2010, 3, '/system/flmParsingAuditorium', 'menuItem', 'C', '0', 'system:flmParsingAuditorium:view', '#', 'admin', '2018-03-01 00:00:00', 'admin', '2020-11-10 10:22:17', '设备列菜单');
INSERT INTO `sys_menu` VALUES (2023, '设备列表查询', 2022, 1, '#', '', 'F', '0', 'system:flmParsingAuditorium:list', '#', 'admin', '2018-03-01 00:00:00', 'ry', '2018-03-01 00:00:00', '');
-- ----------------------------
...
INSERT INTO `sys_role` VALUES (2, '普通角色', 'common', 2, '2', '0', '0', 'admin', '2018-03-16 11:33:00', 'admin', '2019-12-25 16:46:58', '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-08-16 19:01:45', 'admin', '2018-03-16 11:33:00', 'ry', '2020-08-16 19:01:45', '管理员');
-- ----------------------------
